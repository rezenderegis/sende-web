...
export default function NewBroadcastPage() {
  ...
  const step1Valid =
    recipients.tagId || (recipients.contactIds && recipients.contactIds.length > 0)
  ...
  return (
    <div className="p-6 max-w-2xl">
      ...
      <h1 className="text-xl font-semibold text-gray-900 mb-6">Novo Broadcast</h1>
          ...
          <div className="space-y-3 border-t pt-4">
            ...
            {selectedPromptName && !form.campaignPrompt && (
              <div className="flex items-center gap-2 rounded-lg border border-green-200 bg-green-50 px-3 py-2">
                ...
                <button onClick={clearPrompt} className="text-green-600 hover:text-green-800">
            ...
            {selectedPromptName && form.campaignPrompt && (
              <div className="flex items-center justify-between gap-2 rounded-lg border border-green-200 bg-green-50 px-3 py-2">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  {form.campaignPrompt !== campaignPrompts.find(p => p.name === selectedPromptName)?.content && (
                    <span className="text-xs text-green-600 shrink-0">(editado)</span>
                  )}
                </div>
